    ...
    public partial class Frm_CadastroCliente_UC : UserControl
    {
        ...
        private void novoToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                C.ValidaClasse();
                C.ValidaComplemento();
                C.IncluirFichario("C:\\Alura\\CursoWindowsForms\\Fichario");
                ...
                //Fichario F = new Fichario("C:\\Alura\\CursoWindowsForms\\Fichario");
                //if (F.status)
                //{
        ...
        private void abrirToolStripButton_Click(object sender, EventArgs e)
        {
           if (Txt_Codigo.Text == "")
           ...
           else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    C = C.BuscarFichario(Txt_Codigo.Text, "C:\\Alura\\CursoWindowsForms\\Fichario");
                    if (C == null)
                    {
        ...
        private void salvarToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    C.ValidaClasse();
                    C.ValidaComplemento();
                    C.AlterarFichario("C:\\Alura\\CursoWindowsForms\\Fichario");
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            C.ApagarFichario("C:\\Alura\\CursoWindowsForms\\Fichario");
        ...
        private void Btn_Busca_Click(object sender, EventArgs e)
        {
            ...
            {
                Cliente.Unit C = new Cliente.Unit();
                var ListaBusca = C.BuscarFicharioTodos("C:\\Alura\\CursoWindowsForms\\Fichario");
                Frm_Busca FForm = new Frm_Busca(ListaBusca);
                FForm.ShowDialog();
                if (FForm.DialogResult == DialogResult.OK)
                {
                    var idSelect = FForm.idSelect;
                    C = C.BuscarFichario(idSelect, "C:\\Alura\\CursoWindowsForms\\Fichario");
                    if (C == null)
                    {
                        MessageBox.Show("Identificador não encontrado.", "ByteBank", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
